// friend key word is for the access of the 
//private member outside of the class. by the 
//another class or it may be the function.


// but it is not widly used. because it damages the maintainability.
